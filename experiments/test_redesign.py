...
# ]
# --cuda --features full --restore log/h128_full_ollikainen/epoch48_step22896.pt --file_data
# ../data/ollikainen/ollikainen_set.jsonl --file_splits ../data/ollikainen/ollikainen_benchmark.json
...
base_folder = strftime("test/%y%b%d_%I%M%p/", localtime())
...
# Plot the results
files = glob(base_folder + 'alignments/*.fa')
df = DataFrame(columns=['name', 'T', 'score', 'similarity'])
