...
from gpn.experiments.utils import setup_cli_model, featurize, loss_smoothed, loss_nll, plot_log_probs, load_checkpoint
...
for e in range(args.epochs):
    ...
    for train_i, batch in enumerate(loader_train):
        ...
        if args.cuda:
            ...
            print(
                'Tokens/s (train): {:.2f}, Tokens/s (features): {:.2f}, '
                'Mask efficiency: {:.2f}, GPU max allocated: {:.2f}'.format(
