...
from gpn.struct2seq.protein_features import PositionalEncodings
from gpn.struct2seq.self_attention import NeighborAttention, gather_nodes
...
class SequenceModel(nn.Module):
    def __init__(self, num_letters, hidden_dim, num_layers=3,
        ...
        self.decoder_layers = nn.ModuleList([
            NeighborAttention(hidden_dim, hidden_dim * 3)
